function showTime() { 
	...
	var startDate = new Date(2021, 4, 29, 00, 00, 00);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear Yuan Yuan:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----冬青  元元2021-05-20</c>"; 
